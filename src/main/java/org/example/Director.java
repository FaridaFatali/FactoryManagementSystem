...
public class Director extends Manager {
    ...
    public Director(int no, String name, String surname, int year, String workingDepartment, String managingDepartment, double bonus) {
        super(no, name, surname, year, workingDepartment, managingDepartment);
        this.bonus = bonus;
    }
